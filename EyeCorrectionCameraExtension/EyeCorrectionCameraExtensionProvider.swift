...
class EyeCorrectionCameraExtensionDeviceSource: NSObject, CMIOExtensionDeviceSource {
	...
	init(localizedName: String) {
		...
		_streamSource = EyeCorrectionCameraExtensionStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class EyeCorrectionCameraExtensionProviderSource: NSObject, CMIOExtensionProviderSource {
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = EyeCorrectionCameraExtensionDeviceSource(localizedName: "SampleCapture (Swift)")
